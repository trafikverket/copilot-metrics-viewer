...
export class LanguagesTab {
  ...
  constructor(page: Page) {
    this.page = page;
    this.top5Languages = page.getByText(
      "Top 5 Languages by accepted suggestions (prompts)",
    );
    this.numberOfLanguagesValue = page
      .locator(".v-card-item")
      .filter({ has: page.getByText("Number of Languages") })
      .locator(".text-h4");
  }
