...
export class Metrics {
  ...
  constructor(data: any) {
    ...
    this.acceptance_rate_by_count =
      this.total_suggestions_count !== 0
        ? (this.total_acceptances_count / this.total_suggestions_count) * 100
        : 0;
    this.acceptance_rate_by_lines =
      this.total_lines_suggested !== 0
        ? (this.total_lines_accepted / this.total_lines_suggested) * 100
        : 0;
  }
}
