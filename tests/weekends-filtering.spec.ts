...
describe("Weekend filtering debug", () => {
  ...
  it("should test date parsing edge cases", () => {
    ...
    console.log(
      "- Long format (June 14, 2025):",
      date3.toString(),
      "Day:",
      date3.getDay(),
    );
    console.log(
      "- ISO with time (2025-06-14T00:00:00):",
      date4.toString(),
      "Day:",
      date4.getDay(),
    );
    console.log(
      "- ISO with UTC (2025-06-14T00:00:00Z):",
      date5.toString(),
      "Day:",
      date5.getDay(),
    );
    ...
    console.log(
      "- Correct date (2025-06-14T12:00:00Z):",
    ...
    console.log(
      "- Known Saturday (2025-01-04):",
      knownSaturday.toString(),
      "Day:",
      knownSaturday.getDay(),
    );
    console.log(
      "- Known Sunday (2025-01-05):",
      knownSunday.toString(),
      "Day:",
      knownSunday.getDay(),
    );
