...
describe("Options", () => {
  ...
  describe("getApiUrl", () => {
    test("generates correct URL for organization scope", () => {
      ...
      expect(url).toBe(
        "https://api.github.com/orgs/test-org/copilot/metrics?since=2023-01-01&until=2023-12-31",
      );
    });
    ...
    test("generates correct URL for enterprise scope", () => {
      ...
      expect(url).toBe(
        "https://api.github.com/enterprises/test-ent/copilot/metrics?since=2023-01-01",
      );
    });
    ...
    test("generates correct URL for team-organization scope", () => {
      ...
      expect(url).toBe(
        "https://api.github.com/orgs/test-org/team/test-team/copilot/metrics",
      );
    });
    ...
    test("generates correct URL for team-enterprise scope", () => {
      ...
      expect(url).toBe(
        "https://api.github.com/enterprises/test-ent/team/test-team/copilot/metrics",
      );
    });
    ...
    test("throws error for organization scope without githubOrg", () => {
      ...
      expect(() => options.getApiUrl()).toThrow(
        "GitHub organization must be set for organization scope",
      );
    });
    ...
    test("throws error for enterprise scope without githubEnt", () => {
      ...
      expect(() => options.getApiUrl()).toThrow(
        "GitHub enterprise must be set for enterprise scope",
      );
    });
    ...
    test("throws error for team-organization scope without required fields", () => {
      ...
      expect(() => options1.getApiUrl()).toThrow(
        "GitHub organization and team must be set for team-organization scope",
      );
      expect(() => options2.getApiUrl()).toThrow(
        "GitHub organization and team must be set for team-organization scope",
      );
    });
  ...
  describe("getSeatsApiUrl", () => {
    test("generates correct URL for organization scopes", () => {
      ...
      expect(options1.getSeatsApiUrl()).toBe(
        "https://api.github.com/orgs/test-org/copilot/billing/seats",
      );
      expect(options2.getSeatsApiUrl()).toBe(
        "https://api.github.com/orgs/test-org/copilot/billing/seats",
      );
    });
    ...
    test("generates correct URL for enterprise scopes", () => {
      ...
      expect(options1.getSeatsApiUrl()).toBe(
        "https://api.github.com/enterprises/test-ent/copilot/billing/seats",
      );
      expect(options2.getSeatsApiUrl()).toBe(
        "https://api.github.com/enterprises/test-ent/copilot/billing/seats",
      );
    ...
    test("throws error for organization scope without githubOrg", () => {
      ...
      expect(() => options.getSeatsApiUrl()).toThrow(
        "GitHub organization must be set for organization scope",
      );
    });
  ...
  describe("getMockDataPath", () => {
    test("returns correct path for organization scopes", () => {
      ...
      expect(options1.getMockDataPath()).toBe(
        "public/mock-data/organization_metrics_response_sample.json",
      );
      expect(options2.getMockDataPath()).toBe(
        "public/mock-data/organization_metrics_response_sample.json",
      );
    });
    ...
    test("returns correct path for enterprise scopes", () => {
      ...
      expect(options1.getMockDataPath()).toBe(
        "public/mock-data/enterprise_metrics_response_sample.json",
      );
      expect(options2.getMockDataPath()).toBe(
        "public/mock-data/enterprise_metrics_response_sample.json",
      );
    ...
    test("returns default path for undefined scope", () => {
      ...
      expect(options.getMockDataPath()).toBe(
        "public/mock-data/organization_metrics_response_sample.json",
      );
    });
  });
  ...
  describe("getSeatsMockDataPath", () => {
    test("returns correct path for organization scopes", () => {
      ...
      expect(options1.getSeatsMockDataPath()).toBe(
        "public/mock-data/organization_seats_response_sample.json",
      );
      expect(options2.getSeatsMockDataPath()).toBe(
        "public/mock-data/organization_seats_response_sample.json",
      );
    });
    ...
    test("returns default path for undefined scope", () => {
      ...
      expect(options.getSeatsMockDataPath()).toBe(
        "public/mock-data/organization_seats_response_sample.json",
      );
    });
  });
  ...
  describe("validate", () => {
    test("validates team scopes require github team", () => {
      ...
      expect(result1.errors).toContain(
        "GitHub team must be set for team scopes",
      );
    ...
    test("validates organization scopes require github org", () => {
      ...
      expect(result1.isValid).toBe(false);
      expect(result1.errors).toContain(
        "GitHub organization must be set for organization scopes",
      );
      expect(result2.isValid).toBe(false);
      expect(result2.errors).toContain(
        "GitHub organization must be set for organization scopes",
    ...
    test("validates enterprise scopes require github enterprise", () => {
      ...
      expect(result1.isValid).toBe(false);
      expect(result1.errors).toContain(
        "GitHub enterprise must be set for enterprise scopes",
      );
      expect(result2.isValid).toBe(false);
      expect(result2.errors).toContain(
        "GitHub enterprise must be set for enterprise scopes",
